...
! function(e) {
    ...
    e.fn.carousel = function(n) {
        return this.each(function() {
            var r = e(this),
                ...
                s = e.extend({}, t.DEFAULTS, typeof n == "object" && n),
    ...
    r.prototype.toggle = function(t) {
        ...
        var r = s(n),
            o = r.hasClass("open");
        return i(), o || ("ontouchstart" in document.documentElement && e('<div class="dropdown-backdrop"/>').insertBefore(e(this)).on("click", i), r.toggleClass("open")), n.focus(), !1
    ...
    }, e(document).on("click.dropdown.data-api", i).on("click.dropdown.data-api", ".dropdown form", function(e) {
        e.stopPropagation()
    ...
    t.DEFAULTS = {
        ...
        e(document).on("focusin.bs.modal", function(e) {
            this.$element[0] !== e.target && !this.$element.has(e.target).length && this.$element.focus()
        }, this)
    }, t.prototype.escape = function() {
        this.isShown && this.options.keyboard ? this.$element.on("keyup.dismiss.bs.modal", function(e) {
    ...
    t.DEFAULTS = {
        ...
        var i = e(t.currentTarget)[this.type](r).data("bs." + this.type);
        if (!i.options.delay || !i.options.delay.show) return i.show();
        clearTimeout(this.timeout), i.hoverState = "in", this.timeout = setTimeout(function() {
            i.hoverState == "in" && i.show()
        }, i.options.delay.show)
    }, t.prototype.leave = function(t) {
        var n = e(t.currentTarget)[this.type](this._options).data("bs." + this.type);
    ...
    function t(n, r) {
        var i, s = e.proxy(this.process, this),
            o = e(n).is("body") ? e(window) : e(n);
        this.$body = e("body"), this.$scrollElement = o.on("scroll.scroll-spy.data-api", s), this.options = e.extend({}, t.DEFAULTS, r), this.selector = (this.options.target || (i = e(n).attr("href")) && i.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a", this.offsets = e([]), this.targets = e([]), this.activeTarget = null, this.refresh(), this.process()
    }
    t.DEFAULTS = {
        offset: 10
